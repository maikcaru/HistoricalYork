...
public class SlidingLayout extends ViewGroup {
    ...
    /**
     * No-op stubs for {@link com.chenjishi.slide.SlidingLayout.SlideListener}. If you only want to implement a subset
...
//        mCanSlide = canSlide;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.e("Test", "onInterceptTouchEvent " + ev.getX() + " " + getWidth() + " " + action + " " + MotionEvent.ACTION_DOWN);

        // 7 is a magic value which defines how far across the screen
        // the activity-drag happens
        if (ev.getX() > (getWidth() / 7) && action == MotionEvent.ACTION_DOWN) {
            Log.e("Test", "Greater than 7777");
            mDragHelper.cancel();
            return false;
        }

        Log.e("Test", "2ARG: " + mCanSlide);
        ...
        Log.e("Test", "2.5: " + mIsUnableToDrag);
    ...
    static class SlidingPanelLayoutImplJB extends SlidingPanelLayoutImplBase {
         ...
         * the intenoverded effect. This twiddles some internal bits on the view to force
