...
public class MapsActivity extends SlidingActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null){
            int pos = (int) getIntent().getExtras().get("index");
            destination = Sites.get(MapsActivity.this).getAllSites().get(pos);
            Log.e("Test", "oncreate sets up route");
    ...
    private void setUpMap() {
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                intent.putExtra("index", Sites.get(MapsActivity.this).getIndex(marker));
                IntentUtils.startPreviewActivity(MapsActivity.this,intent,mMap);
            }
        });
    ...
    private void addMarkers() {
        ...
        Collection<Site> c = Sites.get(MapsActivity.this).getAllSites();
        ...
        while(itr.hasNext()) {
            ...
            Sites.get(MapsActivity.this).setMarkerForSite(marker, current);
        }
    }

    @Override
    public void startNextActivity(){
        IntentUtils.startPreviewActivity(MapsActivity.this,new Intent(MapsActivity.this,SiteActivity.class));
    }
